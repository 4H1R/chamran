...
return [
    ...
    'attributes' => [
        ...
        'address' => 'آدرس',
        'major_id' => 'رشته اولویت اول',
        'second_major_id' => 'رشته اولویت دوم',
        'third_major_id' => 'رشته اولویت سوم',
        'seventh_math' => 'ریاضی نهایی هفتم',
        'eighth_math' => 'ریاضی نهایی هشتم',
        'ninth_math' => 'ریاضی نهایی نهم',
        'seventh_science' => 'علوم هفتم',
        'eighth_science' => 'علوم هشتم',
        'ninth_science' => 'علوم نهم',
        'seventh_grade' => 'معدل نهایی هفتم',
        'eighth_grade' => 'معدل نهایی هشتم',
        'ninth_grade' => 'معدل نهایی نهم',
        'seventh_discipline' => 'انضباط نهایی هفتم',
        'eighth_discipline' => 'انضباط نهایی هشتم',
        'ninth_discipline' => 'انضباط نهایی نهم',
    ],
];
